      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-3">
        {projects.map((project) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="project-link block overflow-hidden rounded-[1.75rem] border border-[var(--line)] bg-[var(--surface-strong)]"
          >
            <div className="relative aspect-[16/10] border-b border-[var(--line)] bg-[#0f141d]">
              <Image
                src={project.image}
